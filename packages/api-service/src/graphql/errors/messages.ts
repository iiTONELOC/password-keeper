import {
  ...
  PublicKeyErrorMessages,
  AuthSessionErrorMessages,
  GetLoginNonceErrorMessages,
...
export const ACCOUNT_ERROR_MESSAGES: AccountErrorMessages = {
...
export const LOGIN_ERROR_MESSAGES: LoginErrorMessages = {
  ...
  SERVER_SIDE_NONCE_DECRYPT_ERROR:
    'Error decrypting nonce from the server side! The communication may have been tampered with'
};

// There is an AuthSession model that is used by publicly exposed s
export const AUTH_SESSION_ERROR_MESSAGES: AuthSessionErrorMessages = {
...
export const GET_LOGIN_NONCE_ERROR_MESSAGES: GetLoginNonceErrorMessages = {
  ...
  CHALLENGE_DECRYPT_ERROR:
    'Error decrypting challenge! The communication may have been tampered with'
};

export const PUBLIC_KEY_ERROR_MESSAGES: PublicKeyErrorMessages = {
  ...
  MISSING_UPDATE_FIELDS:
    'One of the following fields must be provided: key, label, defaultKey, description, or expiresAt'
};

export const GRAPHQL_ERROR_MESSAGES: GraphQLErrorMessages = {
  DEFAULT: 'Error occurred while fetching data. Please try again.',
  USER_ERROR_MESSAGES,
  ACCOUNT_ERROR_MESSAGES,
  LOGIN_ERROR_MESSAGES,
  PUBLIC_KEY_ERROR_MESSAGES,
  AUTH_SESSION_ERROR_MESSAGES,
  GET_LOGIN_NONCE_ERROR_MESSAGES
};
